...
public class HeaderNamePayTest {
    ...
    @Story("Тестирование на соответствие наименования блока «Онлайн пополнение без комиссии» на соответствие требованиям")
    @RepeatedTest(5)
    @DisplayName("Наименование заголовка «Онлайн пополнение без комиссии»")
    void headerNamePayTest() {
    ...
    @Step("Проверка названия блока «Онлайн пополнение без комиссии» на соответствие требованиям")
