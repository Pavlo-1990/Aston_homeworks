...
@Tag("Iframe")
@Feature("Окно «Реквизиты банковской карты»")
...
// ОЖИДАНИЕ ЗАГОЛОВКА И КНОПКИ «ОПЛАТИТЬ» (СОСТОЯНИЕ DISABLED)
    @Step("Ожидание заголовка: сумма оплаты")
    ...
    @Step("Ожидание заголовка: номер телефона")
    ...
    @Step("Ожидание кнопки «Оплатить» (состояние disabled)")
