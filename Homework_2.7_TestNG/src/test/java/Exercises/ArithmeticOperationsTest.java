...
public class ArithmeticOperationsTest {
    ...
    @Test(
            description = "Метод для вычисления суммы двух чисел",
            dataProvider = "sumArgs"
    )
    ...
    @DataProvider(name = "sumArgs")
    public Object[][] sumArgsDataProvider() {
        return new Object[][]{
    ...
    @Test(
            description = "Метод для вычисления разности между двумя числами",
            enabled = false
    )
    void subtraction() {
    ...
    @Test(
            description = "Метод для вычисления произведения двух чисел",
            dataProvider = "multiplicationArgs"
    )
    ...
    @DataProvider(name = "multiplicationArgs")
    public Object[][] multiplicationArgsDataProvider() {
        List<Object[]> args = new ArrayList<>();
        for (int x = 1; x <= 10; x++) {
            for (int y = 1; y <= 10; y++) {
                args.add(new Object[]{x, y});
            }
        }
    ...
    @Test(description = "Метод для вычисления частного двух чисел")
    void division() {
